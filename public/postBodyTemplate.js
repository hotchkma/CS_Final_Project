...
templates['postBody'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\r\n  <article class = \"post\">\r\n      <div class = \"post-front\">\r\n        <div class = \"post-header\">\r\n          <div class = \"post-item\">\r\n          	"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"comments") || (depth0 != null ? lookupProperty(depth0,"comments") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comments","hash":{},"data":data,"loc":{"start":{"line":26,"column":12},"end":{"line":26,"column":24}}}) : helper)))
    + "\r\n          </div>\r\n          <label for = \"post-contact-info\">Contact Info: </label>\r\n          <div class = \"post-contact-info\">\r\n            "
    + alias4(((helper = (helper = lookupProperty(helpers,"contacts") || (depth0 != null ? lookupProperty(depth0,"contacts") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"contacts","hash":{},"data":data,"loc":{"start":{"line":30,"column":12},"end":{"line":30,"column":24}}}) : helper)))
    + "\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class = post-pass>\r\n        "
    + alias4(((helper = (helper = lookupProperty(helpers,"password") || (depth0 != null ? lookupProperty(depth0,"password") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"password","hash":{},"data":data,"loc":{"start":{"line":35,"column":8},"end":{"line":35,"column":20}}}) : helper)))
    + "\r\n      </div>\r\n  </article>\r\n";
},"useData":true});
})();